...
public class Confirmation : Message
{
    ...
    public SideTradeID SideTradeID
    {
        get
        {
            SideTradeID val = new();
    ...
    public void Set(SideTradeID val) { SideTradeID = val; }
    public SideTradeID Get(SideTradeID val) { GetField(val); return val; }
    public bool IsSet(SideTradeID val) { return IsSetSideTradeID(); }
    public bool IsSetSideTradeID() { return IsSetField(Tags.SideTradeID); }
    ...
    public ExternalTradeID ExternalTradeID
    {
        get
        {
            ExternalTradeID val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(ExternalTradeID val) { ExternalTradeID = val; }
    public ExternalTradeID Get(ExternalTradeID val) { GetField(val); return val; }
    public bool IsSet(ExternalTradeID val) { return IsSetExternalTradeID(); }
    public bool IsSetExternalTradeID() { return IsSetField(Tags.ExternalTradeID); }
