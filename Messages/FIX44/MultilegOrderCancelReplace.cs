...
public class MultilegOrderCancelReplace : Message
{
    ...
    public MultilegOrderCancelReplace(
            ...
            ClOrdID aClOrdID,
            SecondaryClOrdID aSecondaryClOrdID,
            Side aSide,
