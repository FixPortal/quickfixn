...
public static class Tags
{
    ...
    public const int CommissionRate = 1233;
    ...
    public const int NoPartyAltIDs = 22086;
    public const int PartyAltID = 22087;
    public const int PartyAltIDSource = 22088;
    public const int NoPartyAltSubIDs = 22089;
    public const int PartyAltSubID = 22090;
    public const int PartyAltSubIDType = 22091;
    ...
    public const int PremiumDeliveryDate = 5020;
    public const int SpottingProcess = 5216;
    public const int CircleInd = 5224;
    public const int OriginalQty = 5339;
    public const int BasketID = 5419;
    public const int TradingModelType = 5423;
    public const int ExternalTradeID = 5463;
    public const int CrossIndicator = 5478;
    public const int AllocationIndicator = 5527;
    public const int SalesBook = 5528;
    public const int TradeCorrectType = 5533;
    public const int CurrentFace = 5537;
    public const int AllocGrossTradeAmount = 5546;
    public const int AllocCurrentFace = 5547;
    public const int SettlCurrAccruedInterestAmt = 5673;
    public const int SettlCurrNetMoney = 5674;
    public const int TaxRate = 5675;
    public const int AccruedInterestMatchFlag = 5676;
    public const int LocateBroker = 5700;
    public const int LocateIdentifier = 5701;
    public const int DayCount = 5798;
    public const int OutstandingQty = 5827;
    public const int PremiumCurrency = 5830;
    public const int NetPremiumAmount = 5844;
    public const int OrderLinkID = 5975;
    public const int Algo_StrategyIdentifierTag_BMOA = 6102;
    public const int Algo_StartTime_BMOA = 6103;
    public const int Algo_EndTime_BMOA = 6104;
    public const int Algo_MinPercentageVolume_BMOA = 6105;
    public const int Algo_MaxPercentageVolume_BMOA = 6106;
    public const int Algo_TargetPercentVolume_BMOA = 6107;
    public const int Algo_Urgency_BMOA = 6108;
    public const int Algo_OpeningAuctionParticipation_BMOA = 6109;
    public const int Algo_ClosingAuctionParticipation_BMOA = 6110;
    public const int Algo_CorporateBuyback_BMOA = 6111;
    public const int Algo_IWouldPrice_BMOA = 6113;
    public const int Algo_UpperBandPrice_BMOA = 6114;
    public const int Algo_UpperBandTargetPercentVolume_BMOA = 6115;
    public const int Algo_LowerBandPrice_BMOA = 6116;
    public const int Algo_LowerBandTargetPercentVolume_BMOA = 6117;
    public const int Algo_StrategyConfig_BMOA = 6118;
    public const int Algo_TargetPercentForAuction_BMOA = 6119;
    public const int Algo_IWouldPriceType_BMOA = 6121;
    public const int Algo_IWouldSizeType_BMOA = 6123;
    public const int Algo_IWouldSize_BMOA = 6124;
    public const int Algo_IWouldDarkPct_BMOA = 6125;
    public const int Algo_TrackInterlistedVolume_BMOA = 6126;
    public const int Algo_InterlistedRouting_BMOA = 6129;
    public const int Algo_ConditionalMode_BMOA = 6132;
    public const int Algo_SweepBehaviour_BMOA = 6133;
    public const int Algo_SweepTriggerSize_BMOA = 6134;
    public const int Algo_IWouldDarkPrice_BMOA = 6135;
    public const int Algo_IWouldDarkMinExecQty_BMOA = 6136;
    public const int Algo_AuctionMode_BMOA = 6137;
    public const int Algo_AuctionSliceType_BMOA = 6138;
    public const int Algo_RestingPegInstruction_BMOA = 6139;
    public const int Algo_RestingPegDifference_BMOA = 6140;
    public const int Algo_RelativeBenchmark_BMOA = 6142;
    public const int Algo_RelativeLimitPct_BMOA = 6143;
    public const int Algo_RelativePriceType_BMOA = 6144;
    public const int Algo_CompletionRequired_BMOA = 6146;
    public const int QueueOptimisationFlag = 6150;
    public const int Algo_Strategy_BMOA = 6200;
    public const int FixingDate = 6203;
    public const int Tenor = 6215;
    public const int TenorValue2 = 6216;
    public const int NoUnderlyingReinvCoupon = 6223;
    public const int UnderlyingReinvCouponDate = 6224;
    public const int UnderlyingReinvCouponRate = 6225;
    public const int UnderlyingReinvCouponAmt = 6226;
    public const int UnderlyingStartAcrdIntAmt = 6293;
    public const int UnderlyingEndAcrdIntAmt = 6294;
    public const int StrategyPosition = 6351;
    public const int BLPProgType = 6378;
    public const int AdjustedEndCash = 6379;
    public const int CalcAgentLocation = 6384;
    public const int MatrixAgreementType = 6385;
    public const int ApplyRestriction = 6499;
    public const int AllocAgreementDesc = 6504;
    public const int AllocAgreementDate = 6505;
    public const int AllocCalcAgentLocation = 6506;
    public const int AllocMatrixAgreementType = 6507;
    public const int AllocMCAAnnexDate = 6508;
    public const int BenchmarkYield = 6622;
    public const int BenchmarkSecurityDesc = 6632;
    public const int HedgeDirection = 6666;
    public const int MultilegPartNum = 6730;
    public const int UpFrontFee = 6749;
    public const int Anonymous = 6761;
    public const int RegulationID = 6763;
    public const int ActionType = 6812;
    public const int DepoDayCount = 6813;
    public const int ValidSeconds = 6886;
    public const int DueInSeconds = 6887;
    public const int RetailOrder = 7000;
    public const int RecipientRole = 7014;
    public const int Algo_StartTime_Berenberg = 7113;
    public const int Algo_EndTime_Berenberg = 7114;
    public const int Algo_Benchmark_Berenberg = 7115;
    public const int Algo_BeatX_Berenberg = 7119;
    public const int Algo_StrategyIdentifierTag_Berenberg = 7120;
    public const int Algo_AuctionMaxPct_Berenberg = 7121;
    public const int Algo_AuctionOnly_Berenberg = 7122;
    public const int Algo_VolMaxPct_Berenberg = 7126;
    public const int Algo_RelLimitTicker_Berenberg = 7127;
    public const int Algo_WouldDarkPct_Berenberg = 7128;
    public const int Algo_WouldLitPx_Berenberg = 7129;
    public const int Algo_Auction_Berenberg = 7130;
    public const int Algo_Unit_Berenberg = 7131;
    public const int Algo_MinTakeShares_Berenberg = 7132;
    public const int Algo_MarketDirection_Berenberg = 7133;
    public const int Algo_Target_Berenberg = 7134;
    public const int Algo_Target_Type_Berenberg = 7135;
    public const int Algo_RefPx_Berenberg = 7136;
    public const int Algo_WouldDarkPx_Berenberg = 7137;
    public const int Algo_Offset_Berenberg = 7139;
    public const int Algo_Block_Berenberg = 7140;
    public const int Algo_ContMaxPct_Berenberg = 7144;
    public const int Algo_Custom1_Berenberg = 7145;
    public const int Algo_Custom2_Berenberg = 7146;
    public const int Algo_DisplaySize_Berenberg = 7147;
    public const int Algo_Style_Berenberg = 7148;
    public const int Algo_WouldLitPct_Berenberg = 7149;
    public const int Algo_L1Pct_Berenberg = 7152;
    public const int Algo_L2Pct_Berenberg = 7153;
    public const int Algo_L3Pct_Berenberg = 7154;
    public const int Algo_L4Pct_Berenberg = 7155;
    public const int Algo_MinDarkType_Berenberg = 7157;
    public const int Algo_MinDarkFill_Berenberg = 7158;
    public const int Algo_MinTakeAQxShares_Berenberg = 7159;
    public const int Algo_PegOffset_Berenberg = 7162;
    public const int Algo_L2Px_Berenberg = 7164;
    public const int Algo_L3Px_Berenberg = 7165;
    public const int Algo_L4Px_Berenberg = 7166;
    public const int Algo_IWPhase_Berenberg = 7167;
    public const int Algo_RelPxRef_Berenberg = 7168;
    public const int Algo_RelPxOffset_Berenberg = 7169;
    public const int Algo_TargetPct_Berenberg = 7172;
    public const int Algo_Tilt_Berenberg = 7173;
    public const int Algo_Urgency_Berenberg = 7174;
    public const int Algo_Strat1_Berenberg = 7175;
    public const int Algo_Strat2_Berenberg = 7176;
    public const int Algo_SwitchRemainPct_Berenberg = 7177;
    public const int Algo_SwitchTime_Berenberg = 7178;
    public const int Algo_IWLitBench_Berenberg = 7180;
    public const int PortfolioName = 7220;
    public const int TrdRegPublicationReasonFlat = 8013;
    public const int TradePriceConditionFlat = 8014;
    public const int OrderAttributeTypes = 8015;
    public const int VenueTransactionIdentificationCode = 8016;
    public const int InterlistedListingMic = 8207;
    public const int InterlistedTradeFxRate = 8901;
    public const int InterlistedParentCurrency = 8906;
    public const int InterlistedSecurityID = 8907;
    public const int InterlistedSettlementCurrency = 8908;
    public const int InterlistedFillPrice = 8931;
    public const int InterlistedTradeSize = 8932;
    public const int TradingSystemTicketNumber = 9009;
    public const int ExecDeltaHedge = 9015;
    public const int HedgeTradeType = 9016;
    public const int PutOrCallCurrency = 9034;
    public const int MarketType = 9102;
    public const int HedgeDate = 9112;
    public const int SettlFixingDate = 9119;
    public const int SettlCurrency2 = 9120;
    public const int HedgeAmount = 9123;
    public const int DisplayInst = 9140;
    public const int Account_BMO = 9191;
    public const int AllocationType = 9223;
    public const int ActionCode = 9263;
    public const int Routable = 9303;
    public const int EndClientOrderID = 9403;
    public const int BuysideTrader = 9404;
    public const int FlatFlag = 9503;
    public const int NoCompetingQuotes = 9516;
    public const int CompetingQuoteDealer = 9517;
    public const int CompetingQuote = 9518;
    public const int CompetingQuoteLeg2 = 9520;
    public const int CompetingQuoteType = 9523;
    public const int UnsolicitedFlag = 9534;
    public const int TraderBook = 9536;
    public const int StagedOrderIsInquiry = 9575;
    public const int CompetingQuoteFwdPoints = 9591;
    public const int NoNotes = 9610;
    public const int NoteType = 9611;
    public const int NoteLabel = 9612;
    public const int NoteText = 9613;
    public const int BLPTicketType = 9654;
    public const int LegYield = 9655;
    public const int HedgeRate = 9657;
    public const int ContactEmailAddress = 9676;
    public const int NoDealers = 9690;
    public const int DealerID = 9691;
    public const int DealerIDSource = 9692;
    public const int DealerQuotePriceType = 9693;
    public const int DealerQuotePrice = 9694;
    public const int DealerQuoteOrdQty = 9695;
    public const int NonTradedSideQuote = 9718;
    public const int NonTradedSideQuoteLeg2 = 9720;
    public const int NonTradedSideFwdPoints = 9791;
    public const int AEPTradeID = 9875;
    public const int SwapTradeType = 9876;
    public const int BTOrderInst = 9881;
    public const int PricingNo = 9896;
    public const int BLOTSequenceNumber = 9902;
    public const int Application = 9906;
    public const int NoCompDealerQuotes = 10009;
    public const int CompDealerID = 10010;
    public const int CompDealerQuotePrice = 10011;
    public const int CompDealerQuotePriceType = 10012;
    public const int CompDealerParQuote = 10015;
    public const int BenchmarkSecurityType = 20000;
    public const int HedgeCalcType = 20001;
    public const int LiquidityTakerLEI = 21727;
    public const int LiquidityTakerIsUSPerson = 21807;
    public const int LiquidityMakerLEI = 21808;
    public const int LiquidityMakerIsUSPerson = 21828;
    public const int IsSEFTrade = 21829;
    public const int SwapReportingAgency = 21833;
    public const int BloombergSEFID = 21834;
    public const int ReportingParty = 21835;
    public const int AutoConfirm = 22000;
    public const int AllocLegNo = 22001;
    public const int MakerTaker = 22002;
    public const int ProductType = 22003;
    public const int LegTenor = 22010;
    public const int CommissionValueType = 22012;
    public const int LegTrdContinuation = 22015;
    public const int NoRegulatorTradeIDs = 22026;
    public const int ClientRegulatoryTradeID = 22027;
    public const int AgencyRegulatoryTradeID = 22028;
    public const int USINearLegValue = 22031;
    public const int DealerNetMoney = 22037;
    public const int TradePurpose = 22039;
    public const int DV01 = 22040;
    public const int LegDV01 = 22041;
    public const int CreditRatingSource = 22045;
    public const int LastMidPrice = 22052;
    public const int MidPriceType = 22053;
    public const int UnderlyingPriceType = 22055;
    public const int GrossYield = 22072;
    public const int LastNotional = 22074;
    public const int SalesCredit = 22075;
    public const int NoRefPrices = 22078;
    public const int RefPrice = 22079;
    public const int RefPriceType = 22080;
    public const int RefPriceSource = 22081;
    public const int RefPriceFirmIndicator = 22082;
    public const int RefPriceInventoryIndicator = 22083;
    public const int RefQuoteID = 22085;
    public const int SettlCurrGrossTradeAmt = 22092;
    public const int SettlCurrAccruedInterestAmount = 22093;
    public const int MadeAvailableForTradingIndicator = 22102;
    public const int PreFactoredPrice = 22104;
    public const int CoverQuantity = 22105;
    public const int TypeOfPrice = 22106;
    public const int MarkitWireEligble = 22107;
    public const int MandatoryToClearDF = 22109;
    public const int AggregateFillsOperationType = 22112;
    public const int AvgQuotedSpread = 22113;
    public const int AuctionMethod = 22114;
    public const int AuctionName = 22115;
    public const int OfferingType = 22116;
    public const int NoLegRefPrices = 22117;
    public const int LegRefPrice = 22118;
    public const int LegRefPriceType = 22119;
    public const int LegRefPriceSource = 22120;
    public const int LegRefPriceFirmIndicator = 22121;
    public const int LegRefPriceInventoryIndicator = 22122;
    public const int LegRefQuoteID = 22123;
    public const int LegNetMoney = 22124;
    public const int LegAccruedInterestAmt = 22125;
    public const int LegCoverPrice = 22126;
    public const int CouponDateGenerationMethod = 22127;
    public const int SEFReported = 22128;
    public const int UnderlyingCouponDateGenerationMethod = 22141;
    public const int LegCouponDateGenerationMethod = 22142;
    public const int RefPriceSide = 22150;
    public const int PreAllocStrategyName = 22152;
    public const int RefPriceText = 22156;
    public const int IRSBasketPriceIndicator = 22158;
    public const int Ccy1MarketType = 22159;
    public const int Ccy2MarketType = 22160;
    public const int CompDealerQuotePriceLeg2 = 22161;
    public const int CompDealerQuoteForwardPoints = 22162;
    public const int CompDealerQuoteSwapPoints = 22163;
    public const int RefPriceleg2 = 22164;
    public const int RefPriceForwardPoints = 22165;
    public const int RefPriceSwapPoints = 22166;
    public const int LegPriceDelta = 22168;
    public const int LegBaseInstrument = 22169;
    public const int LegLastParPx = 22174;
    public const int LegNumDaysInterest = 22175;
    public const int RFQMinDealerExceptionReason = 22176;
    public const int CompDealerQuoteOrdQty = 22179;
    public const int LegAvgPx = 22180;
    public const int LegCumQty = 22181;
    public const int LegLeavesQty = 22182;
    public const int LegText = 22183;
    public const int ChatID = 22184;
    public const int CommissionMode = 22193;
    public const int DaysToTerm = 22194;
    public const int RefPriceSize = 22197;
    public const int RefPriceTime = 22198;
    public const int LegRefPriceSize = 22199;
    public const int LegRefPriceTime = 22200;
    public const int LegSettlCurrAmt = 22205;
    public const int LegSettlCurrFxRate = 22206;
    public const int LegSettlCurrFxRateCalc = 22207;
    public const int RepositoryReportingIndicator = 22210;
    public const int AlgoStrategyName = 22213;
    public const int NoReferenceIds = 22215;
    public const int ReferenceIDType = 22216;
    public const int ReferenceID = 22217;
    public const int ConvertibleBondEquityPrice = 22219;
    public const int WorkingStockIndicator = 22220;
    public const int ComplexRebate = 22224;
    public const int LegPutOrCallCurrency = 22225;
    public const int OptionExerciseDeliveryDate = 22226;
    public const int LegStrategyPosition = 22227;
    public const int LegComplexRebate = 22228;
    public const int CompDealerRollSpread = 22229;
    public const int LegOptionExerciseDeliveryDate = 22230;
    public const int UnderlyingTenor = 22231;
    public const int LegCalculatedNotional = 22245;
    public const int RegulatoryTradeRule = 22246;
    public const int LegTrdType = 22247;
    public const int LegRegulatoryTradeRule = 22248;
    public const int NoPriceQualifiers = 22250;
    public const int PriceQualifier = 22251;
    public const int OptionHashID = 22252;
    public const int CustomizedIndicator = 22253;
    public const int LegCustomizedIndicator = 22254;
    public const int MarkitWireBetaTradeID = 22255;
    public const int PricedToClearCCP = 22256;
    public const int MandatoryToClearEMIR = 22257;
    public const int MarkitWireBookID = 22258;
    public const int OptionSettlAmtDeterminationMethod = 22259;
    public const int LegRiskWeight = 22260;
    public const int CalculatedCurrency = 22262;
    public const int LegCalculatedCurrency = 22263;
    public const int LegOptionHashID = 22264;
    public const int HedgeCurrency = 22265;
    public const int ClientConvertibleBondEquityPrice = 22266;
    public const int ConvertibleBondNukeBidPrice = 22267;
    public const int ConvertibleBondNukeOfferPrice = 22268;
    public const int ConvertibleBondEquityCurrency = 22269;
    public const int AllocationPriceMethod = 22270;
    public const int SecurityValidationIndicator = 22271;
    public const int BrokerName = 22272;
    public const int BrokerID = 22273;
    public const int BrokerFirmName = 22274;
    public const int BrokerDealcode = 22275;
    public const int CompDealerQuoteType = 22276;
    public const int PriceOffset = 22277;
    public const int AllocationCount = 22280;
    public const int TradeNotes = 22283;
    public const int HedgeSpread = 22291;
    public const int HedgeSecurityID = 22292;
    public const int HedgeSecurityIDSource = 22293;
    public const int HedgePrice = 22294;
    public const int HedgePriceType = 22295;
    public const int HedgeQty = 22296;
    public const int HedgeQtyType = 22297;
    public const int OfferingSize = 22309;
    public const int FloatingRateIndex = 22326;
    public const int FloatingRateIndexCurvePeriod = 22327;
    public const int FloatingRateIndexCurveUnit = 22328;
    public const int FloatingRateIndexCurveSpread = 22329;
    public const int UnderlyingIndexCurvePeriod = 22365;
    public const int UnderlyingIndexCurveUnit = 22366;
    public const int NoClientCustomData = 22370;
    public const int ClientCustomDataName = 22371;
    public const int ClientCustomDataValue = 22372;
    public const int ClientBidPx = 22427;
    public const int ClientOfferPx = 22428;
    public const int ClientCustomDataType = 22433;
    public const int LegYieldType = 22435;
    public const int ClientCustomDataStreamDesc = 22437;
    public const int DealerSide = 22448;
    public const int LegDealerSide = 22449;
    public const int BasketItemCount = 22450;
    public const int BasketItemNumber = 22451;
    public const int ClientCustomDataPrecision = 22452;
    public const int UnderlyingSecuritySeries = 22453;
    public const int HedgeDelta = 22454;
    public const int MiscFeeLegRefID = 22457;
    public const int TRACEModifier = 22458;
    public const int LegClientBidPx = 22459;
    public const int LegClientOfferPx = 22460;
    public const int SecLendReason = 22461;
    public const int LegPremiumDeliveryDate = 22463;
    public const int OrderQtyUnits = 22464;
    public const int LastQtyUnits = 22465;
    public const int ConstantQtyType = 22466;
    public const int LegTradeContinuation = 22469;
    public const int ClientCustomDataLegRefID = 22471;
    public const int ExecRuleName = 22480;
    public const int CompDealerQuoteLegRefID = 22481;
    public const int CancelReason = 22483;
    public const int AutoOrdType = 22484;
    public const int CountryOfJurisdiction = 22492;
    public const int CurrencyOfIssue = 22493;
    public const int RelativeValueLegRefID = 22495;
    public const int NoExecRuleNames = 22497;
    public const int FixingSource = 23001;
    public const int LegPremiumSettlCurrency = 23002;
    public const int LegPremiumSettlCurrAmt = 23003;
    public const int PremiumSettlCurrAmt = 23004;
    public const int PremiumSettlCurrency = 23005;
    public const int LegPremium = 23007;
    ...
    public const int NOE = 800;
    public const int PriceBid = 5002;
    public const int PriceAsk = 5003;
    public const int PriceTrade = 5004;
    public const int NoTradeFeature = 7713;
    public const int NoTradeKey = 7714;
    public const int SweepStyle = 9786;
    public const int FireQuantity = 9815;
    public const int Paused = 9879;
    public const int BTReportInst = 9882;
    public const int DealNumber = 9885;
    public const int TriggerQuantity = 9888;
    public const int ExchangeReserve = 9899;
    public const int QuoteQty = 9908;
    public const int BangFlag = 9913;
    public const int BangCounterParty = 9914;
    public const int BangSDP = 9915;
    public const int SysadminID = 9930;
    public const int TradeStyle = 9987;
    public const int PartyIDExecutingFirm = 20001;
    public const int PartyIDOrderOriginationFirm = 20013;
    public const int PartyIDReportingIntermediary = 20072;
    public const int PartyIDExecutionVenue = 20073;
