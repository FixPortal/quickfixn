...
public class GenMessageTests
{
    ...
    {
        // FP Enhancement: 2026-05-24 — FixPortal's custom FIX44 spec extends NoSidesGroup with additional tags, so the
        // standard upstream field order no longer matches the regenerated group. Ignored (like upstream's pre-existing
        // commented-out variant) rather than tracking the custom order, which churns on every spec change.
        int[] expFieldOrder = new int[] {
            ...
            1016, 1072, 1057, 38, 152, 22464, 22466, 151, 775, 29, 416, 1028, 5673, 5674, 5675, 5676, 5798, 6379, 9503, 22078,
            0
        };
